...
insert into events (bookingName, bookingEmail, eventCategoryId, eventStartTime, eventNotes,eventDuration)
value ('SomsriRakdee(SJ-3)', 'somsri.rak@mail.kmutt.ac.th', '1', '2022-5-24 16:30:00', 'ขอปรึกษาปัญหาเพื่อนไม่ช่วยงาน',30);
insert into events (bookingName, bookingEmail, eventCategoryId, eventStartTime,eventDuration)
value ('สมเกียรติ ขยันเรียน กลุ่ม (TT-4)', 'somkiat.kay@kmutt.ac.th', '3', '2022-5-28 12:00:00',15);
